import { LruBlockCache, OmHttpBackend, OmDataType } from "@openmeteo/file-reader";
const COLOR_SCALES = {
  cape: {
    type: "breakpoint",
    unit: "J/kg",
