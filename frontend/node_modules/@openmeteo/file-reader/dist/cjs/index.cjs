...
class BrowserBlockCache {
    constructor(options = {}) {
        ...
        if (typeof caches === "undefined") {
            throw new Error("BrowserBlockCache is browser-only. Import it dynamically in the client (e.g. inside onMount()).");
        }
    ...
    async prefetch(key, fetchFn, fileSize) {
...
exports.BlockCacheBackend = BlockCacheBackend;
exports.BrowserBlockCache = BrowserBlockCache;
exports.FileBackend = FileBackendNode;
exports.LruBlockCache = LruBlockCache;
exports.MemoryHttpBackend = MemoryHttpBackend;
exports.OmFileReader = OmFileReader;
exports.OmHttpBackend = OmHttpBackend;
